...
@interface HouseSellViewController ()
{
    RequestHelp *dataRequest;
}
@end

@implementation HouseSellViewController
...
- (void)viewDidLoad
{
    ...
    [sendDic2 setObject:@"30,50" forKey: @"house_mny"];
    ...
    [dataRequest connectionWithAddress:@"http://115.28.49.147:8080/fang/doJsonSearchSellHouse.action"];
